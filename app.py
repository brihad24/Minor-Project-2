...
try:
    model_best = tensorflow.keras.models.load_model('best_model_101class.hdf5', custom_objects={'BatchNormalization': BatchNormalization})
    print(model_best)
...
@app.route('/')
def index():
    img = 'static/1foodbg3.jpg'
    return render_template('index.html', img=img)


@app.route('/recognize')
def magic():
    img_recog = 'static/FOODbgaa.jpg'
    return render_template('recognize.html', img=img_recog)
